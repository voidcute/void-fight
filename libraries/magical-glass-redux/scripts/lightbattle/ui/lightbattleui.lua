...
function LightBattleUI:init()
    ...
    -- active: 237
    -- inactive: 280
    self.help_window = HelpWindow(SCREEN_WIDTH/2, 280)
    ...
    for i = 1, 3 do
        self.enemies_special_text[i] = DynamicGradientText("", 91, 15 + 32 * (i-1), nil, nil, nil, {["font"] = "main_mono"})
                        ...
                        if enemy.show_mercy_bar and self.draw_mercy then
                            ...
                            if enemy.disable_mercy then
                                ...
                                if self.draw_percents and enemy.selectable then
                                    ...
                                    Draw.setColor(COLORS.black)
                                    Draw.printAlign(enemy:getMercyDisplay(), (mercy_x + 51) + shadow_offset, (9 + y_offset) + shadow_offset, "center")
                                    ...
                                    Draw.printAlign(enemy:getMercyDisplay(), mercy_x + 51, 9 + y_offset, "center")
                                end
                            end
                        end
                    end
