    ...
    for _,enemy in ipairs(target) do
        if enemy.done_state == nil then
            ...
            Game.battle.timer:after(10/30 * count, function()
                ...
                effect.layer = math.max(enemy.layer, LIGHT_BATTLE_LAYERS["above_arena_border"]) + 0.1
                ...
                if success then
                    ...
                    Game.battle.timer:every(3/30, function()
                        ...
                        snowflake.layer = math.max(enemy.layer, LIGHT_BATTLE_LAYERS["above_arena_border"]) + 0.02
