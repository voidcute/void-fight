...
-- The limit size of the HP gague while not in multi mode
-- If true, it will limit it to 99
-- If false, there won't be a limit
-- If a number, it will limit it to that number
