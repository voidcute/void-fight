...
-- Allows you to display images that can be closed (used for the Punch Card)
-- In addition, it mimics the glitch where you can wrong-warp and move during cutscenes like in Undertale
