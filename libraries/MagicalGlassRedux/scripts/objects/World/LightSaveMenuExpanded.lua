...
-- An expanded version of the Undertale save menu, allows you to use all 3 slots, similar to Deltatraveler
...
function LightSaveMenuExpanded:draw()
    ...
    if self.state == "OVERWRITE" then
        ...
        local function drawOverwriteSave(data, x, y)
            ...
            love.graphics.print("LV" .. " " .. (mg.save_level or Game.party[1] and Game.party[1]:getLightLV() or 0), x, y)
...
function LightSaveMenuExpanded:drawSaveFile(index, data, x, y, selected, header)
    ...
    elseif not data then
        ...
        elseif self.saved_file then
            love.graphics.print("LV" .. " " .. (mg.save_level or 0), x + 26, y + 6)
        else
            love.graphics.print("LV" .. " " .. (mg.save_level or 0), x + 50, y + 6)
        end
