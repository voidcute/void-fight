...
-- Pixelated lines dust effect, when killing a large enemy
-- Works for both the overworld and both battle types objects
function DustEffectLine:init(texture, x, y, allow_black_pixels, after)
    ...
    if #Game.stage:getObjects(DustEffectParticle) + #Game.stage:getObjects(DustEffectLineParticle) <= 6400 then
